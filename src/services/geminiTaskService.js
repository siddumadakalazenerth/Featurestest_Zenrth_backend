 ...
 */
async function runFurnishingSuggestion(photo, knownDimensions) {
  ...
  const roomType = photo.analysis?.roomType || 'Other';
...
- Color palette: pick 2-3 colors that complement the room's existing walls and flooring.
