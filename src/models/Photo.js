...
const photoSchema = new mongoose.Schema(
  {
    ...
    diskPath: { type: String, required: true }, // absolute path on disk, used to read the file for analysis
    url: { type: String, required: true }, // path served by /uploads
    ...
    furnishingSuggestion: {
      ...
      windowTreatments: {
        type: { type: String, default: '' }, // e.g. "sheer linen curtains"
        color: { type: String, default: '' }, // e.g. "warm white"
        notes: { type: String, default: '' },
      },
      summary: { type: String, default: '' },
